...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post stations_url, params: { station: { company: @station.company, free_bikes: @station.free_bikes, free_slots: @station.free_slots, name: @station.name } }
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { company: @station.company, free_bikes: @station.free_bikes, free_slots: @station.free_slots, name: @station.name } }
